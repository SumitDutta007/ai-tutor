...
export async function createFeedback(data) {
  ...
  const transcript =
    typeof getData(data, "transcript") === "string"
  ...
  try {
    ...
    const avgResponseLength =
      studentResponses.reduce((acc, msg) => acc + msg.content.length, 0) /
        totalResponses || 0;
    ...
    const prompt = `
        ...
        - For minimal interaction : scores 0-30
        - For partial engagement : scores 30-50
        - For active engagement : scores 50-85
        ...
        - Basic engagement starts at 0 points
        - Active participation can earn 30-85
        - Exceptional communication can reach 85-100

        Technical Knowledge:
        - Understanding of basic concepts starts at 0-30
        - Partial understanding earns 30-60
        - Good understanding with minor gaps: 60-80
        - Excellent understanding: 80-100
        - Consider both correct and partially correct answers
        - Reward attempts to work through difficult concepts

        Problem Solving:
        - Effort to approach challenges starts at 0-30
        - Basic problem-solving attempts earn 30-50
        - Good analytical thinking earns 50-85
        ...
        - Basic participation starts at 0
        - Growing confidence during session: 30-65
    ...
    const cleanedResponse = {
      ...
      areasForImprovement:
        parsedResponse.areasForImprovement.map(cleanMarkdown),
    };
