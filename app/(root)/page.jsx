  ...
  return (
      <main className="flex lg:mt-20 flex-col lg:flex-row items-center justify-between min-h-[calc(90vh-4.3rem)]">
        ...
        <div className="max-w-xl ml-[10%] z-10 mt-20 lg:mt-0">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-wider my-8">AI <br/> Tutor</h1>
          <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[25rem] lg:max-w-[30rem]">Your personalised tutor</p>
          <div className="relative w-full h-8 rounded-full bg-[linear-gradient(to_right,_#656565,_#ba5af6,_#472a85,_#5300a0,_#757575,_#656565)] bg-[length:200%] animate-gradient shadow-[0_0_15px_rgba(255,255,255,0.3)] py-6 my-4">
            <div className="absolute inset-[3px] bg-black rounded-full flex justify-center items-center transition duration-500 ease-in-out hover:text-[#c55af6] text-white">Let's get started
            </div>
          </div>
        </div>
